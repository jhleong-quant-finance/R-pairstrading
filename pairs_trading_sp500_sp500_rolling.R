...
cfg_prescreen_data_file = paste0(cfg_pairs_trade_Rdata_path,'prescreen_sp500_sp500_rolling.rda');
cfg_matched_pairs_data_file = paste0(cfg_pairs_trade_Rdata_path,'matched_pairs_sp500_sp500_rolling.rda');
                         ...
                         .errorhandling = 'pass') %dopar%
{
  ...
  try(matched_algo_ret <- matching_algo.rolling(m_top_rank[i, 'price1'], 
                                                m_top_rank[i, 'price2'], 
                                                prices, prices, cfg_rolling_width));
