...
cfg_prescreen_data_file = paste0(cfg_pairs_trade_Rdata_path,'prescreen_sp400_sp400_rolling.rda');
cfg_matched_pairs_data_file = paste0(cfg_pairs_trade_Rdata_path,'matched_pairs_sp400_sp400_rolling.rda');
