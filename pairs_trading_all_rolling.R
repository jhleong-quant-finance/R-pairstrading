...
# configuration
#******************************************************************    
#cfg_num_prescreen_pairs = 5000;

cfg_prescreen_data_file = paste0(cfg_pairs_trade_Rdata_path,'prescreen_all_rolling.rda');
cfg_matched_pairs_data_file = paste0(cfg_pairs_trade_Rdata_path,'matched_pairs_all_rolling.rda');
...
load_top100_etf_stockData(data);
